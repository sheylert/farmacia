		...
		<div class="col-md-9 col-sm-9">
		 ...
		 <i class="ace-icon fa fa-circle"></i> Beneficiarios de <?=$nombre_titular; ?></li>
			...
			<div class="col-md-2 col-sm-2">			
					<a href="<?= base_url().'index.php/entrega'?>" class="btn btn-app btn-info">
				...
				{ ?>
					<tr>
						...
						<td class="hidden-480">
							...
							<td class="hidden-480">
							<a href="<?= base_url().'index.php/entrega/entrega_beneficiario/'.$id_titular.'/'.$row->id;?>" class="" title='Medicamentos Beneficiario' data-tool='tooltip'>
