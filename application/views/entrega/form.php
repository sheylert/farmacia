<?php 
 $ruta_controller = base_url() . "index.php/entrega/store";?>
...
<div class="page-header">
 ...
 <form action="<?php echo $ruta_controller;?>" method="post" enctype="multipart/form-data">
							...
							<div class="widget-header">
							 ...
							 <div class="widget-body">
								 <div class="widget-main">
									<div>
										<label for="form-field-select-1"><?php echo "Cédula: ".$titular->cedula?></label> 
								     </div>
				   ...
				   <div class="col-xs-12 text-center">
				   	    ...
				   	    <input type="hidden" id="beneficiario_id" name="beneficiario_id" value= 0 >
