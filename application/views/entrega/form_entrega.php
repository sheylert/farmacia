<?php 
 $ruta_controller = base_url() . "index.php/entrega/store_entregado";?>
			...
			<tbody class="text-center">
				...
				{ ?>
					<tr>
						...
						<?php 	
                          ...
                          echo anchor(site_url('/entrega/destroy/'.$entrega->id.'/'.$row->id), $label, 'onclick="javasciprt: return confirm(\'Esta seguro de eliminar el Titular?\')"');
				...
				?>
				   ...
				   <div class="col-xs-12 text-center">
				   	...
				   	<a class="btn btn-default radius-4" href="<?= base_url().'index.php/entrega'; ?>">Volver registro</a>
