...
<?php //print_r ($this->session->userdata('arr_usuarios'));?>
 <div class="row no-gutters">
		...
		<div class="col-md-9 col-sm-9">
		 ...
		 <i class="ace-icon fa fa-circle"></i> Asignaciones <?=$nombre_titular; ?> (Beneficiario)</li>
		</div>													
		<div class="col-md-2 col-sm-2">
					<a href="<?= base_url().'index.php/control/beneficiario/'.$id_titular?>" class="btn btn-app btn-info">
  ...
  <div class="row no-gutters">
	...
	<?php  $ruta_controller = base_url() . "index.php/control/store_beneficiario/"?>
 ...
 <form action="<?php echo $ruta_controller;?>" method="post" enctype="multipart/form-data">	
 	 ...
 	 <div class="col-xs-12 col-sm-4">
	    ...
	    <div class="col-xs-12 col-sm-1">
	   	 ...
	   	 <input type="hidden" id="beneficiario_id" name="beneficiario_id" value="<?=$id_beneficiario?>">
</form>
					...
					<tr>
						...
						<td class="hidden-480">
						 <?php 	
                          ...
                          echo anchor(site_url('/control/destroy_beneficiario/' .$id_titular.'/'. $id_beneficiario.'/'.$row->id), $label, 'onclick="javasciprt: return confirm(\'Esta seguro de eliminar el Medicamento?\')"');
