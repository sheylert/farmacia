<?php 
 $ruta_controller = base_url() . "index.php/titular/store_beneficiario";?>
...
<div class="page-header">
 ...
 <form action="<?php echo $ruta_controller;?>" method="post" enctype="multipart/form-data">
				   ...
				   <input type="hidden" id="imagen" name="imagen" value="avatar.png">
				    <input type="hidden" id="id_titular" name="id_titular" value="<?=$id_titular?>" >
				  
				   <div class="col-xs-12 text-center">

				   		<a class="btn btn-default radius-4" href="<?= base_url().'index.php/titular/beneficiario/'.$id_titular; ?>">Volver listado</a>
